...
namespace Kuyam.GettyImagesClient.Services
{
    public class SearchForCreativeImages
    {

        // token received from CreateSession/RenewSession API call
        public SearchForImagesResponse Search(string token, string searchTerm, int itemStartNumber = 1)
        {
            var searchForImagesRequest = new SearchForImagesRequest
            {
                ...
                SearchForImages2RequestBody = new SearchForImages2RequestBody
                {
                    ...
                    ResultOptions = new ResultOptions { ItemCount = 50, ItemStartNumber = itemStartNumber }
                }
            };
