    ...
    var o = false,
        ...
        z = function (f, d) {
            ...
            this.init = function () {
                ...
                if (!b.ispage || !b.cantouch && !b.isieold && !b.isie9mobile) {
                    ...
                    if (b.isie9mobile) b.scrollmom = {
                        ...
                        b.cursorgrabvalue && (b.css(b.ispage ? b.doc : b.win, {
                ...
                if (this.doc[0].nodeName == "IFRAME") {
                    var h = function () {
                        ...
                        b.onmousedown), b.cursorgrabvalue && b.css(e(c.body), {
                            cursor: b.cursorgrabvalue
                        });
            ...
            b.ishwscroll && b.hastransition && b.opt.usetransition ? (this.prepareTransition = function (c) {
                ...
                b._unbind(b.doc, b.transitionend,
                b.onScrollEnd);
