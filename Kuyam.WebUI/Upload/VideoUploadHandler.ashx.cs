...
namespace Kuyam.WebUI.Upload
{
    ...
    /// </summary>
    public class VideoUploadHandler : IHttpHandler, IRequiresSessionState
    {
        ...
        private void UploadWholeFile(HttpContext context, List<FilesStatus> statuses)
        {
            for (int i = 0; i < context.Request.Files.Count; i++)
            {
                ...
                KalturaMediaEntry kalturaMediaEntry = KalturaService.StartSessionAndUploadMedia(_fileStream, Kaltura.KalturaMediaType.VIDEO, fileName);
                _fileStream.Flush();
                _fileStream.Close();
                DeleteFile(fullPath);
                ...
                Medium media = new Medium
                {
                    ...
                    MediaTypeID = (int)Types.MediaType.Video,
