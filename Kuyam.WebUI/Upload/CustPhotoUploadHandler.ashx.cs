...
{
    /// <summary>
    /// Summary description for CustPhotoUploadHandler
    /// </summary>
    public class CustPhotoUploadHandler : IHttpHandler, IRequiresSessionState
    {
            ...
            try
            {
                for (int i = 0; i < context.Request.Files.Count; i++)
                {
                    ...
                    CompanyProfileService _companyProfileService =
                        EngineContext.Current.Resolve<CompanyProfileService>();
                    Medium media = new Medium
                    {
                        CustID = MySession.CustID,
                        CustTypeID = (int) Types.CustType.Personal,
