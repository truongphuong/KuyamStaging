...
namespace Kuyam.WebUI.Sitemap.Autofac.Modules
{
    public class MvcSiteMapProviderModule : global::Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            TimeSpan absoluteCacheExpiration = TimeSpan.FromMinutes(int.Parse(ConfigurationManager.AppSettings["MvcSiteMapProvider_CacheDuration"]));
            ...
            string[] includeAssembliesForScan = new string[] { "Kuyam.WebUI" };
